...
| 2026-07-09 | ~~Strip restyled to the design system (3px top bar, soft tint active)~~ REVERTED same day - Zoran wants the ORIGINAL pill look back and it is now LOCKED: 1.5px colored border per stage, dashed border = automation, solid colour fill + dark text when open. Do not restyle again without an explicit ask. Cascade keeps width:100% (cc-pipe-strip is flex) |
