...
**Still to do in Phase 1:** swap board/config-view stage RENDERING onto the master (they still read DB rows - fine while data matches). Step 3 = Phase 3 cleanup (retire stage_transitions + apply-preset copy-stamping + seed_default_stage_transitions).
