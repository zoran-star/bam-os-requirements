...
- Still open in Build 2: config view "tied to your offer" + click-through (editing loop); coaches from staff (Build 4); social_proof/Google (Build 5); qualification_config from preset+offer values; pricing transparency MODE -> preset-level (structural, later).
