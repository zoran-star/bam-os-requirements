...
- [Member Management → Client Portal](project_member_management_portal.md) — 2026-05-20: incorporating the BAM GTA member-management system into the client portal as a client-side "Members" feature. Stripe model = Connect; Phase 1a schema SQL written (`bam-portal/supabase/member-management-schema.sql`, not yet run). Resume via `/member-management-continue`.
