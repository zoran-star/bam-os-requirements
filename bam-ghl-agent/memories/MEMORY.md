...
- [Member Management → Client Portal](project_member_management_portal.md) — 2026-05-20: incorporating the BAM GTA member-management system into the client portal as a client-side "Members" feature. Planning done; Phase 1 blocked on a Stripe-access decision. Resume via `/member-management-continue`.
