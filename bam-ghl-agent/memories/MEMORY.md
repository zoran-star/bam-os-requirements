...
- [App Store / Native App Launch](project_app_store_launch.md) — 2026-05-20: getting the client portal onto the iOS App Store + Google Play. PWA shipped (installable); Capacitor wrapper built at `bam-portal-app/`. Next: confirm server.url, build push notifications, compile on a Mac, submit. **Active — read this to continue the app work.**
