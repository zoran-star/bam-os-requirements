...
const LIVE_BOOKING_TRAILER =
  ...
  `CONFIRM BEFORE BOOKING: when the lead offers or agrees to a day/time, do NOT book it yet - first ASK them to confirm you should book it (for example "Want me to lock that in and book it for you?"). Only set book=true AFTER they clearly say yes to you booking it (e.g. "yes please", "go ahead"). If they have only named a time but not yet okayed you booking it, your reply IS that confirmation question, with book=false. BUT once you HAVE already asked to book that slot and the lead replies with any clear yes ("sure", "yes", "ok", "sounds good", "perfect", "please do", or simply thanking you for that day/time), that IS the yes - set book=true now and make your reply the booking confirmation. Do NOT ask the book question a second time: re-confirming a slot they already agreed to stalls the booking and reads as if you were not listening. ` +
