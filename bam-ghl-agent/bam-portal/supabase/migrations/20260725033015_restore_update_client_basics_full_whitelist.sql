-- The clients_tax_config migration redefined update_client_basics from the
-- oldest copy and dropped columns later migrations added (time_zone, kpi_data,
-- onboarding_setup, ads_content_approval_required). This restores the FULL
-- current whitelist (20260719000521_onboarding_setup.sql) plus tax_config.
