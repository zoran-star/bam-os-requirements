...
declare
  ...
  -- contact_id here is TEXT and holds the GHL contact id string.
  text_cid_tables text[] := array[
...
begin
  ...
  -- TEXT contact_id columns hold the GHL contact id string: re-point by string.
  foreach t in array text_cid_tables loop
  ...
  -- UUID contact_id columns are FKs to contacts.id: re-point by uuid.
